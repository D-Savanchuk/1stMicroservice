...
const reqInstance = axios.create({
    ...
    const getLots = async () => {
       await companies.forEach(async (el)=>{            
            const { data } = await reqInstance.get(`https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=DPBZXCTKST7UZ5BU
            `);
