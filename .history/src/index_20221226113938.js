...
const reqInstance = axios.create({
    ...
    const getLots = async () => {
        ...
        return {'Symbol': data['Meta Data']['2. Symbol'], 'Last': data['Meta Data']['3. Last Refreshed'], 'Day Data': data['Time Series (5min)'][keys[0]]['1. open'],'Day Data': data['Time Series (5min)'][keys[0]]['4. close']};
      };
