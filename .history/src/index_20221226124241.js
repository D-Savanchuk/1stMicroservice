...
const reqInstance = axios.create({
    ...
    const getLots = async () => {
        0a49790005734a15a6a330c2adb4c459
        companies.forEach(async (el)=>{            
            const { data } = await reqInstance.get(`https://api.twelvedata.com/time_series?symbol=IBM,EUR/USD,ETH/BTC:Huobi,TRP:TSX&interval=1min&apikey=0a49790005734a15a6a330c2adb4c459
            `);
            console.log(data);
