...
const reqInstance = axios.create({
    ...
    const getLots = async () => {
        ...
        return {'Symbol': data['Meta Data']['2. Symbol'], 'Last': data['Meta Data']['3. Last Refreshed'], 'Open': data['Time Series (5min)'][keys[0]]['1. open'],'Close': data['Time Series (5min)'][keys[0]]['4. close']};
      };
